...
$config1 =<< "CFG1";
      seqfile = $seq
      treefile = $tree   
      outfile = /home/jiale/Bioinformatics/Project/06.Ka_Ks/20240228_FEGs/Results/mlc/$index[$i]\_mlc00
      ndata =1
...
CFG1
 ...
 $config2 =<< "CFG2";
      seqfile = $seq
      treefile = $tree
      outfile = /home/jiale/Bioinformatics/Project/06.Ka_Ks/20240228_FEGs/Results/mlc/$index[$i]\_mlc20
      ndata =1
